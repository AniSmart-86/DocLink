...
const Profile = () => {
  ...
  const [userData, setUserData] = useState({
    ...
    phone: '8086717124',
    address:{
      line1: 'KINGS WAY GRA ENUGU',
      line2: 'INDEPENDENCY LAYOUT, NIGERIA',
  ...
  return (
    ...
    <div>
      {
        isEdit ?
        <button className='border border-blue-600 px-8 py-2 rounded-full hover:bg-blue-600 hover:text-white hover:scale-x-105 transition-all duration-1000 ease-in-out' onClick={()=>setIsEdit(false)}>Save</button> :
